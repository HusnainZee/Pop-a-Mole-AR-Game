...
namespace Niantic.ARDKExamples.Helpers
{
  ...
  public class ARHitTester: MonoBehaviour
  {
    ...
    private IARSession _session;
        ...
        //  Instantiating Gameobject and stopping plane detection

        private ARPlaneManager _planeManager;
        private bool _objectInstantiated = false;
    ...
    private void TouchBegan(Touch touch)
    {
            ...
            {
                return; // Object already instantiated, exit the method
            }
          ...
          _objectInstantiated = true;
            _planeManager.ObjectPlaced();
            //GameCanvas.SetActive(true);
            _planeManager.ClearAllPlanes();
